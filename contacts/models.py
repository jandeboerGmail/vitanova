...
class Evenement(models.Model):
	...
	organisator_info = models.CharField(max_length=80,blank=False,default = 'Vita Nova Baru Bangkit Dari Abu.')
	...
	activiteiten_info_2 = models.CharField(max_length=30,blank=True)
	volgende_datum_1 = models.CharField(max_length=50,blank=True)
	volgende_datum_2 = models.CharField(max_length=50,blank=True)
	#info_image =  models.CharField(max_length=20,blank=True)
	uitverkocht =  models.BooleanField(blank=False,default=False)
	memo = models.TextField(blank = True)
	slug = models.SlugField(max_length=120,default='slug')
	datum_inserted = models.DateTimeField(default=timezone.now, blank=False)
	datum_updated = models.DateTimeField(default=timezone.now, blank=False)
